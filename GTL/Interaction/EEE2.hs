...
import GTL.Interaction.Optimality2 (optimalResponse2)
import GTL.Data.Mockup (DeterministicMockupStrategy, Role)
import GTL.Data.Strategy (deterministicStrategiesXYA)
import Data.Ix (Ix)
...
isAPureEEE2 rol1 rol2 sig strat1 strat2 = opt1 == strat1 && opt2 == strat2
    where (mock1, mock2) = mockups2 rol1 rol2 sig (randomizeStrat strat1) (randomizeStrat strat2)
          (opt1, opt2) = optimalResponse2 rol1 rol2 mock1 mock2
          randomizeStrat strat x y = certainly $ strat x y
...
findPureEEEs2 rol1 rol2 sig = filter (uncurry $ isAPureEEE2 rol1 rol2 sig) deterministicStrategiesXYA2
    where deterministicStrategiesXYA2 = cartesianProduct2 deterministicStrategiesXYA deterministicStrategiesXYA
